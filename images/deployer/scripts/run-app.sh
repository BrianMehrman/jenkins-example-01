...
export host=$(kubectl get services -o jsonpath={.items..metadata.name} -l application=spilo,cluster-name=acid-minimal-cluster,spilo-role=master);
export port="5432"
...
base="kubernetes/overlays/postgres-op/simple-app"
